...
This project follows the global session-handoff practice (`~/.Codex/AGENTS.md`): maintain a
...
**Opted in to cross-machine WIP sync** (see `~/.Codex/AGENTS.md` → Session Handoff Continuity —
